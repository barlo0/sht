...
tdcli_function ({ID = "GetUser",user_id_ = 1001132193,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '𓌹 ᯓ مــبـرمـج الســورس ★ 𓌺\n['..result.first_name_..'](t.me/bar_lo0o0)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1001132193, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
if text == 'barlo' or text == 'الشيطان' then  
local Text = [[  
⚡⚡《هكر السورس يرحقلبي》⚡⚡
]]  
keyboard = {}   
